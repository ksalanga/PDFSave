 ...
 * - auto_save (boolean) - indicates if this pdf has auto saving on or not.
 * - progress_notification (boolean) - turns on reading progress notification for this specific pdf.
 * 
 * Bookmark Object keys: ** SUBJECT TO CHANGE **
 * - id (string) - id generated by application? (could change to name as our primary key).
