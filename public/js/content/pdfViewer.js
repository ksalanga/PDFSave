...
function openSavePageAlert()
{
    ...
    '  </symbol>' + 
    '</svg>' + 
    '<div id="saveNotification" class="alert alert-primary align-items-center alert-fade" role="alert">' + 
    '  <button type="button" class="close" data-dismiss="alert" aria-label="Close" style="height:30px; width:30px">' + 
    '      <span aria-hidden="true">&times;</span>' + 
    '    </button>' + 
    '  <div class="d-flex">' + 
    `    <img src=${chrome.runtime.getURL('logo192.png')} alt=" " style="height:25px; width:25px">` + 
    '    <h4 class="alert-heading" style="padding-left:10px">PDF Save</h4>' + 
    '  </div>' + 
    '<hr>' + 
    '  <div class="d-flex">' + 
    '    <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Info:"><use xlink:href="#info-fill"/></svg>' + 
    '    <div style="padding-left: 10px">' + 
    '      Make sure to save your page position before you close!' + 
    '    </div>' + 
    '  </div>' + 
    '  <br>' + 
    '  <div class="d-flex">' + 
    '    <div style="padding-left: 10px">' + 
    '      You can prompt to save the page using:' + 
    '      <ul>' + 
    '        <li>Right Click -> Save at Page</li>' + 
    '        <li>Keyboard Command (default: Ctrl+Shift+.)</li>' + 
    '        <li>Extension Popup</li>' + 
    '      </ul>' + 
    '    </div>' + 
    '  </div>' + 
    '</div>' + 
